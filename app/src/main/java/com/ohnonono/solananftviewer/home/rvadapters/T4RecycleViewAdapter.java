...
public class T4RecycleViewAdapter extends RecyclerView.Adapter<T4RecycleViewAdapter.MyViewHolder> {
    private final ArrayList<SNFTHomepage.DescriptiveCollection> list;
    private Context context;

    public T4RecycleViewAdapter(ArrayList<SNFTHomepage.DescriptiveCollection> list) {
        this.list = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new T4RecycleViewAdapter.MyViewHolder(inflater.inflate(R.layout.item_t4recycleview, parent, false));
    }
